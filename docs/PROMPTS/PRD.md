...
Genera un **PRD ligero** para FTGO en formato Markdown, partiendo del brief del **Anexo A** de este documento.
...
### TODO 4 — Estructura mínima detallada
...
Guarda el resultado en `prompts_mejorados/prd_mejorado.md`.
